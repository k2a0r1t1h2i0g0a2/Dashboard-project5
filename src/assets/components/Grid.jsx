...
const Grid = () => {
  const data = [
    ...
    // Add more data objects as needed for the other 8 items
  ];
const renderItems = () => {
    ...
    return (
      <div>
        <Container>
          <Row style={{ display: "grid", gridTemplateColumns: "auto auto" }}>
            <Col sm={4} className="medico ">
              Medico Sales
              <div>
              ...
              <div>
                <Container>
                  <Row className="line">
                    ...
                    <Col className="list">Lab Test</Col>
                  </Row>
                  <Row className="line">
                    <Col sm>
                      <svg
                  ...
                  <Row className="line">
                    ...
                    <Col className="list">Medicine Order</Col>
                  </Row>
                  <Row className="line">
                    <Col>
                      <svg
                    ...
                    <Col className="list">Message</Col>
                  </Row>
                  <Row className="line">
                    <Col>
                      <svg
                    ...
                    <Col className="list">Payment</Col>
                  </Row>
                  <Row className="line">
                    <Col>
                      <svg
                    ...
                    <Col className="list">Setting</Col>
                  </Row>
                </Container>
                <div>
                  <Container>
            ...
            >
              ...
              <div className="head">
                <Container>
                  ...
                  <Row className="head1">
                    ...
                    <Col>
                      <input type="text" placeholder="Invoice ID"></input>
                    </Col>
                    <Col>
              ...
              <div className="box1">{renderItems()}</div>
              <div className="box1">{renderItems()}</div>
              <div className="box1">{renderItems()}</div>
              <div className="box1">{renderItems()}</div>
              <div className="box1">{renderItems()}</div>
